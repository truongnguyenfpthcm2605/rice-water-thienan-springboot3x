...
public interface OrdersRepository extends JpaRepository<Orders, String> {
    ...
    @Query("select o from tbl_orders  o where  o.status =:status and o.active =true")
    Page<Orders> findByStatus(Pageable pageable,@Param("status") String status);

    @Query("select  o from tbl_orders  o where o.name like :keyword or o.address like :keyword or o.phone like :keyword and o.active = true")
