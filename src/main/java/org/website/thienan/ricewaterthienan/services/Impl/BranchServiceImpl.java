...
public class BranchServiceImpl implements BranchService {
    ...
    @Override
    @Caching(
            put = {@CachePut(cacheNames = "branch", key = "#BranchRequest.id")},
            evict = {
                @CacheEvict(cacheNames = "branchs", allEntries = true),
                @CacheEvict(cacheNames = "branchsActive", allEntries = true)
            })
    ...
    public Optional<Branch> findById(Integer id) {
        Branch branch =
                branchRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Not found Branch"));
    ...
    public Optional<Branch> findByName(String name) {
        Branch branch =
                branchRepository.findByName(name).orElseThrow(() -> new ResourceNotFoundException("Not found Branch"));
        return Optional.of(branch);
    }
