...
public class BranchController {
    ...
    public ResponseEntity<MessageResponse> findById(@PathVariable Integer id) {
    ...
    public ResponseEntity<MessageResponse> findByName(@PathVariable String name) {
    ...
    @PreAuthorize("hasAnyRole('Admin','Staff')")
    public ResponseEntity<MessageResponse> update(@Valid @RequestBody BranchRequest branchRequest, @PathVariable Integer id) {
        Branch branch = branchService.findById(id).orElseThrow(() -> new ResourceNotFoundException("Branch not found!"));
