...
public class ProductController {
    ...
    public ResponseEntity<MessageResponse> findAll(
            @Valid @NotNull @PathVariable Optional<Integer> page,
    ...
    public ResponseEntity<MessageResponse> findFilter(
            @Valid @PathVariable Optional<Integer> page,
    ...
    public ResponseEntity<MessageResponse> findById(@Valid @NotNull @PathVariable String id) {
        ...
        Product product =
                productService.findById(id).orElseThrow(() -> new ResourceNotFoundException("Not found Product"));
        return new ResponseEntity<>(
                MessageResponse.builder()
                        .code(HttpStatus.OK.value())
    ...
    public ResponseEntity<MessageResponse> update(
            @Valid @NotNull @PathVariable String id, @RequestBody ProductRequest productRequest) {
        Product product =
                productService.findById(id).orElseThrow(() -> new ResourceNotFoundException("Not found Product"));
    ...
    private Product getProduct(Product product, ProductRequest productRequest) {
        ...
        product.setAccount(accountServices
                .findById(productRequest.getAccountId())
                .orElseThrow(() -> new ResourceNotFoundException("Not found Account")));
        product.setBranch(branchService
                .findById(productRequest.getBranchId())
                .orElseThrow(() -> new ResourceNotFoundException("Not found Branch")));
        product.setBrand(brandService
                .findById(productRequest.getBrandId())
                .orElseThrow(() -> new ResourceNotFoundException("Not found Brand")));
