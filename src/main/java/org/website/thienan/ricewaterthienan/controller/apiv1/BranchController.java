...
public class BranchController {
    ...
    public ResponseEntity<MessageResponse> findById(@Valid @NotNull @PathVariable Integer id) {
        ...
        Branch branch =
                branchService.findById(id).orElseThrow(() -> new ResourceNotFoundException("Branch not found!"));
        return new ResponseEntity<>(
                MessageResponse.builder()
                        .code(HttpStatus.OK.value())
                        .timeStamp(LocalDateTime.now())
    ...
    public ResponseEntity<MessageResponse> findByName(@Valid @NotNull @PathVariable String name) {
        ...
        Branch branch =
                branchService.findByName(name).orElseThrow(() -> new ResourceNotFoundException("Branch not found!"));
        return new ResponseEntity<>(
                MessageResponse.builder()
                        .code(HttpStatus.OK.value())
                        .timeStamp(LocalDateTime.now())
    ...
    public ResponseEntity<MessageResponse> save(@Valid @RequestBody BranchRequest branchRequest) {
        ...
        branch.setAccount(accountServices
                .findById(branchRequest.getAccountId())
    ...
    public ResponseEntity<MessageResponse> update(
            @Valid @RequestBody BranchRequest branchRequest, @NotNull @PathVariable Integer id) {
        ...
        return new ResponseEntity<>(
                MessageResponse.builder()
                        ...
                        .data(branchService.update(branch).getId())
                        .build(),
                HttpStatus.OK);
    }
