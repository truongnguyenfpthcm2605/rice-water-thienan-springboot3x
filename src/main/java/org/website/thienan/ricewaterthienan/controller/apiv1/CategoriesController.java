...
public class CategoriesController {
    ...
    public ResponseEntity<MessageResponse> findByName(@Valid @NotNull @PathVariable String name) {
        ...
        Categories categories = categoriesService
                .findByName(name)
                .orElseThrow(() -> new ResourceNotFoundException("Not found Category ID" + name));
        return new ResponseEntity<>(
                MessageResponse.builder()
                        .code(HttpStatus.OK.value())
    ...
    public ResponseEntity<MessageResponse> save(@RequestBody CategoriesRequest categoriesRequest) {
        ...
        categories.setAccount(accountServices
                .findById(categoriesRequest.getAccountId())
                .orElseThrow(() ->
                        new ResourceNotFoundException("Not found Account ID" + categoriesRequest.getAccountId())));
    ...
    public ResponseEntity<MessageResponse> update(
            @Valid @RequestBody CategoriesRequest categoriesRequest, @NotNull @PathVariable Integer id) {
        log.info("Update category by id {}", id);
        Categories categories = categoriesService
                .findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Categories Notfound ID" + id));
        categories.setName(categoriesRequest.getName());
        categories.setLink(categoriesRequest.getLink());
        categories.setContent(categoriesRequest.getContent());
        categories.setIntroduction(categoriesRequest.getIntroduction());
