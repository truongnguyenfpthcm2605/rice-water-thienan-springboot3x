...
public class ProductController {
    ...
    public ResponseEntity<MessageResponse> save(@RequestBody ProductRequest productRequest){
        ...
        product.setAccount(accountServices.findById(productRequest.getAccountId()).orElseThrow());
        product.setBranch(branchService.findById(productRequest.getBranchId()).orElseThrow());
        product.setBrand(brandService.findById(productRequest.getBrandId()).orElseThrow());
        product.setCategories(productRequest.getCategories().stream().map(e -> categoriesService.findByName(e).orElseThrow()).collect(Collectors.toSet()));
