...
public class BrandController {
    ...
    public ResponseEntity<MessageResponse> findByName(@Valid @NotNull @PathVariable String name) {
        ...
        Brand brand =
                brandService.findByName(name).orElseThrow(() -> new ResourceNotFoundException("Brand not found!"));
        return new ResponseEntity<>(
                MessageResponse.builder()
                        .code(HttpStatus.OK.value())
                        .timeStamp(LocalDateTime.now())
    ...
    public ResponseEntity<MessageResponse> save(@Valid @RequestBody BrandRequest brandRequest) {
        ...
        brand.setAccount(accountServices
                .findById(brandRequest.getAccountId())
    ...
    public ResponseEntity<MessageResponse> update(
            @Valid @RequestBody BrandRequest brandRequest, @NotNull @PathVariable Integer id) {
